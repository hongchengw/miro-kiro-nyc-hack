  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] flex flex-col items-center justify-center px-6 text-center">
      ...
      <button
        ...
        className="mt-10 h-12 px-8 rounded-xl bg-emerald-600 text-white text-base font-semibold flex items-center gap-2 hover:bg-emerald-500 transition-colors shadow-md"
      >
